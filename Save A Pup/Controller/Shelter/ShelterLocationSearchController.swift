//
//  ShelterLocationSearchController.swift
//  Save A Pup
//
...
class ShelterLocationSearchController: UIViewController {
    
    let searchVC: ShelterSearchController
    ...
    init(searchVC: ShelterSearchController) {
    ...
    private func setupNavigationController() {
        ...
        let leftImageAction = UIAction(title: "Back") { (action) in
            self.searchVC.view.becomeFirstResponder()
...
extension ShelterLocationSearchController: UISearchBarDelegate {
...
extension ShelterLocationSearchController: MKLocalSearchCompleterDelegate {
...
extension ShelterLocationSearchController: UITableViewDataSource {
...
extension ShelterLocationSearchController: UITableViewDelegate {
